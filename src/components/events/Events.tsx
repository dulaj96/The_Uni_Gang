...
const Events: React.FC = () => {
    return (
        <section id="events" className="relative pt-24 pb-12 px-4 md:px-8 overflow-hidden font-sans">
            ...
            <div className="absolute top-20 left-[10%] opacity-20 rotate-12 -z-10">
                <span className="material-symbols-outlined text-[120px] text-primary">school</span>
            </div>
            <div className="absolute bottom-10 right-[15%] opacity-20 -rotate-12 -z-10">
                <span className="material-symbols-outlined text-[100px] text-primary">menu_book</span>
            </div>
            <div className="absolute top-40 right-[5%] opacity-10 rotate-45 -z-10">
                <span className="material-symbols-outlined text-[80px] text-primary">music_note</span>
            </div>
            <div className="absolute bottom-20 left-[5%] opacity-10 -rotate-45 -z-10">
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
                <div className="space-y-4">
                    <span className="bg-primary/10 text-primary px-4 py-1.5 rounded-full text-[10px] uppercase tracking-widest font-bold">What's Happening</span>
                ...
                <div className="flex items-center gap-6 font-sans">
                    <a className="group flex items-center gap-2 text-sm font-semibold text-on-surface bg-white/30 backdrop-blur-md border border-white/40 px-6 py-3.5 rounded-full hover:bg-white/50 hover:border-white/60 transition-all duration-300 shadow-sm" href="#">
            ...
            <div className="relative max-w-[1440px] mx-auto">
                <div className="flex overflow-x-auto gap-8 pb-12 px-4 hide-scrollbar snap-x snap-mandatory">
                    {/* Card 1: Musical */}
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-8 mt-12 grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="p-8 rounded-[2rem] bg-surface-container-low text-center">
                    <p className="text-3xl font-extrabold text-primary mb-1">12k+</p>
                    <p className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Active Students</p>
                </div>
                <div className="p-8 rounded-[2rem] bg-surface-container-low text-center">
                    <p className="text-3xl font-extrabold text-primary mb-1">450</p>
