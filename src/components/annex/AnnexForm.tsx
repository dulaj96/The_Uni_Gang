            ...
            <div className='w-full max-w-[300px]'>
              ...
              <div className="mt-2">
                <input
                  type="text"
                  id="title"
                  className="bg-white p-2 block w-full sm:text-sm rounded-md"
                  value={title}
            ...
            <div className='w-full max-w-[300px]'>
              ...
              <div className="mt-2 relative rounded-md shadow-sm">
                <input
                  type="number"
                  id="price"
                  className="p-2 block w-full sm:text-sm bg-white rounded-md pr-12"
                  value={price}
            ...
            <div className='w-full max-w-[300px]'>
              ...
              <div className="mt-2">
                <textarea
                  id="address"
                  rows={4}
                  className="shadow-sm p-2 block w-full sm:text-sm bg-white rounded-md"
                  value={address}
            ...
            <div className='w-full max-w-[300px]'>
              ...
              <div className="mt-2">
                <textarea
                  id="description"
                  rows={4}
                  className="p-2 block w-full sm:text-sm bg-white rounded-md"
                  value={description}
              ...
              <div className="mt-2">
                {(existingImageUrls.length + images.length) < 3 && (
                  <input
                    type="file"
                    id="images"
                    className="p-2 block w-full bg-white sm:text-sm rounded-md"
                    multiple
