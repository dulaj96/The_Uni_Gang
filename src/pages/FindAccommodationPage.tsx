      ...
      <section className='bg-gray-200 p-5 rounded-xl'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white shadow rounded-md overflow-hidden">
            <img src="https://via.placeholder.com/350" alt="Annex" className="w-full h-48 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-white shadow rounded-md overflow-hidden">
            <img src="https://via.placeholder.com/350/00FF00" alt="Annex" className="w-full h-48 object-cover" />
            <div className="p-4">
