...
export default function ProposalAstroHubPage({ setPage }: { setPage: (p: string) => void }) {
  ...
  return (
    <div className={`w-full min-h-screen py-10 px-4 sm:px-6 lg:px-12 font-sinhala transition-colors duration-300 relative overflow-hidden ${
      isDark ? 'bg-slate-950 text-white selection:bg-purple-500/30' : 'bg-slate-50 text-slate-900 selection:bg-rose-500/20'
    }`}>
      
      {/* ATMOSPHERIC AMBIENT GLOW ORBS */}
      <div className={`absolute top-10 left-1/4 w-[600px] h-[600px] rounded-full blur-[150px] pointer-events-none ${
        isDark ? 'bg-purple-600/15' : 'bg-purple-300/25'
      }`} />
      <div className={`absolute top-1/3 right-10 w-[500px] h-[500px] rounded-full blur-[150px] pointer-events-none ${
        isDark ? 'bg-amber-500/10' : 'bg-rose-300/20'
      }`} />
      <div className={`absolute bottom-10 left-10 w-[600px] h-[600px] rounded-full blur-[160px] pointer-events-none ${
        isDark ? 'bg-rose-500/10' : 'bg-purple-300/20'
      }`} />

      <div className="max-w-6xl mx-auto space-y-12 relative z-10">

        {/* 1. HERO BANNER WITH REAL HIGH-RES VISUAL COUPLE IMAGE */}
        <div className={`relative rounded-[3rem] p-1 transition-all ${
          isDark ? 'bg-gradient-to-r from-purple-500/40 via-pink-500/30 to-amber-500/40 shadow-2xl shadow-purple-950/40' : 'bg-gradient-to-r from-purple-300/60 via-rose-300/60 to-amber-300/60 shadow-xl'
        }`}>
          <div className={`rounded-[2.9rem] p-6 sm:p-10 lg:p-12 backdrop-blur-2xl relative overflow-hidden grid lg:grid-cols-12 gap-8 items-center ${
            ...
            <div className="lg:col-span-7 space-y-5 relative z-10 text-center lg:text-left">
              ...
              <h1 className={`text-xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight font-sinhala ${
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 text-xs font-bold font-sinhala pt-1">
                <div className={`flex items-center gap-2 px-4 py-2 rounded-full border backdrop-blur-md shadow-sm ${
              ...
              <div className="relative w-full max-w-sm rounded-[2.5rem] p-2 bg-gradient-to-tr from-amber-400/40 via-purple-500/40 to-pink-500/40 shadow-2xl">
                <div className={`rounded-[2.2rem] overflow-hidden relative shadow-inner aspect-[4/5] ${
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-t pointer-events-none ${
                    isDark ? 'from-slate-950 via-slate-950/20 to-transparent' : 'from-slate-900/80 via-slate-900/20 to-transparent'
                  }`} />
        ...
        <div className={`rounded-[3rem] p-1 shadow-2xl border backdrop-blur-2xl relative overflow-hidden transition-all ${
          ...
          <div className="p-6 sm:p-10 space-y-8 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-xs font-bold">
              ...
              {/* BRIDE INPUT CARD */}
              <div className={`p-6 rounded-[2.2rem] border shadow-md space-y-5 relative overflow-hidden group ${
                isDark ? 'bg-gradient-to-b from-pink-950/40 to-slate-950/90 border-pink-500/30' : 'bg-gradient-to-b from-pink-50/80 to-white border-pink-200'
              }`}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full rounded-2xl px-4 py-3.5 text-xs font-bold focus:outline-none focus:ring-2 focus:ring-pink-500/50 shadow-inner cursor-pointer border ${
              ...
              {/* GROOM INPUT CARD */}
              <div className={`p-6 rounded-[2.2rem] border shadow-md space-y-5 relative overflow-hidden group ${
                isDark ? 'bg-gradient-to-b from-indigo-950/40 to-slate-950/90 border-indigo-500/30' : 'bg-gradient-to-b from-indigo-50/80 to-white border-indigo-200'
              }`}>
                <div className={`flex items-center justify-between border-b pb-3 ${
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full rounded-2xl px-4 py-3.5 text-xs font-bold focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-inner cursor-pointer border ${
            ...
            <div className="space-y-4 pt-2">
              <button
                ...
                className={`w-full py-4 px-6 rounded-2xl font-black text-xs flex items-center justify-between border transition-all cursor-pointer shadow-md group ${
